...
try {
  ...
  const { router: signageRemoteControlRouter } = require('./server-signage-remote-control.cjs');
  ...
  app.use('/api/signage', signageRemoteControlRouter);
  ...
  console.log('Digital Signage remote control active');
