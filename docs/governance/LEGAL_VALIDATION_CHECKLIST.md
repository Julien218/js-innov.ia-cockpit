...
- [ ] Confirmer la base légale de chaque traitement
...
- [ ] Vérifier les mécanismes de transfert (adéquacy, SCC, BCR)
...
- [ ] Notamment: IA (profiling), vidéosurveillance, données sensibles

## Procédures d'incident
- [ ] Procédure de notification de violation (Art. 33-34 RGPD)
