...
function requestedTools(message) {
  ...
  if (!requests.length
    && /(?:analys|audit|v[eé]rifi|contr[oô]l|diagnost|inspect).*(?:frontend|front-end|bouton|interface|application|cockpit|code|react|ui)|(?:frontend|front-end|bouton|interface|application|cockpit|code|react|ui).*(?:analys|audit|v[eé]rifi|contr[oô]l|diagnost|inspect)/i.test(text)
