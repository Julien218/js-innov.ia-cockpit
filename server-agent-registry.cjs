...
const ELYNEA_AGENT = Object.freeze({
  ...
  capabilities: [
    ...
    'social', 'marketing', 'campaign', 'facebook', 'instagram', 'tiktok',
  ],
  status: 'active',
...
const SKILL_REGISTRY = Object.freeze([
  ...
  { key: 'social-command', name: 'Elynea Social Command', kind: 'skill', role: 'social_campaign_ops', label: 'Campagnes multi-marques Facebook, Instagram et TikTok', domains: ['cockpit.jsinnovia.com'], aliases: ['social command', 'réseaux sociaux', 'reseaux sociaux', 'campagne sociale', 'facebook', 'instagram', 'tiktok', 'reel', 'story'], capabilities: ['social', 'marketing', 'campaign', 'content-planning', 'copywriting', 'brand-compliance', 'brand-sync', 'media-generation', 'publishing', 'calendar', 'analytics', 'conversion-attribution', 'facebook', 'instagram', 'tiktok'], system_prompt: 'Pour toute campagne, charge d’abord l’identité versionnée de la marque depuis Social Command. Le site dédié est la source visuelle de vérité. Ne considère jamais une publication comme publiée sans provider_post_id et preuve technique. Toute publication réelle reste soumise aux validations et coupe-circuits du Cockpit.', status: 'active' },
