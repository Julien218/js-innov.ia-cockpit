...
const OWNER_ROUTES = [
  "/", "/hainoflow", "/publisya", "/assurances", "/documents", "/clients", "/leads", "/demandes", "/projets", "/donnees-projets", "/taches",
...
export const ROLE_ROUTES = {
  ...
  collaborateur: [
    "/", "/hainoflow", "/publisya", "/ecran-geant", "/clients", "/leads", "/documents", "/projets", "/donnees-projets", "/taches", "/demandes", "/devis", "/agent", "/agents-ia"
  ],
  ...
  client: [
    "/", "/hainoflow", "/publisya", "/ecran-geant", "/mes-projets", "/donnees-projets", "/mes-devis", "/mes-factures", "/confidentialite"
  ],
};
