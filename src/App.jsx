...
import PilotyaSign from "@/pages/PilotyaSign";
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppErrorBoundary><AppLayout /></AppErrorBoundary>}>
          ...
          <Route path="/pilotyasign" element={isAdmin || user?.role === "collaborateur" ? <PageBoundary><PilotyaSign /></PageBoundary> : <Navigate to="/" replace />} />
