    ...
    <section className="relative overflow-hidden rounded-3xl border border-[#8A2BE2]/30 bg-[linear-gradient(135deg,#070B1C_0%,#101B3D_55%,#0B2940_100%)] p-5 text-white shadow-xl shadow-[#101B3D]/15 md:p-7">
      ...
      <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <div className="h-14 w-14 shrink-0 overflow-hidden rounded-2xl border border-[#8A2BE2]/40 bg-black/25 p-1 shadow-lg shadow-black/20"><img src="/signelya-symbol-approved-512.png" alt="Logo SIGNELYA" className="h-full w-full rounded-xl object-cover" /></div>
