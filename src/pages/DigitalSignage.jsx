  ...
  return <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="rounded-2xl border bg-card p-5">
        ...
        <div className="relative mt-3 aspect-video rounded-xl bg-black flex items-center justify-center overflow-hidden">
          {preview ? (String(preview.mime_type).startsWith("image/")
            ...
            : <p className="text-xs text-white/50">Choisissez un média</p>}
